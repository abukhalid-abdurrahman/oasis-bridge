...
public interface IBridge
{
    ...
    Task<(string PublicKey, string PrivateKey, string SeedPhrase)> CreateAccountAsync(CancellationToken token = default);
    ...
    Task<(string PublicKey, string PrivateKey)> RestoreAccountAsync(string seedPhrase, CancellationToken token = default);
    ...
    Task<TransactionResponse> WithdrawAsync(decimal amount, string senderAccountAddress, string senderPrivateKey);
    ...
    Task<TransactionResponse> DepositAsync(decimal amount, string receiverAccountAddress);
    ...
    Task<BridgeTransactionStatus> GetTransactionStatusAsync(string transactionHash, CancellationToken token = default);
}